...
main = do
  ...
  withTracerProviderSpec \tracerProviderSpec -> do
...
withTracerProviderSpec :: (TracerProviderSpec -> IO a) -> IO a
withTracerProviderSpec action =
  otlpSpanExporter defaultOTLPSpanExporterSpec { otlpSpanExporterSpecLogger = defaultOutput stdout } \spanExporter ->
    action $ defaultTracerProviderSpec
