...
data ExportMetricsServiceRequest
  = ExportMetricsServiceRequest'_constructor {_ExportMetricsServiceRequest'resourceMetrics :: !(Data.Vector.Vector OTel.SDK.OTLP.Bindings.Metrics.V1.Metrics.ResourceMetrics),
