...
module OTel.SDK.OTLP.Bindings.Collector.Trace.V1.TraceService (
...
import qualified OTel.SDK.OTLP.Bindings.Trace.V1.Trace
{- | Fields :
     
         * 'OTel.SDK.OTLP.Bindings.Collector.Trace.V1.TraceService_Fields.rejectedSpans' @:: Lens' ExportTracePartialSuccess Data.Int.Int64@
         * 'OTel.SDK.OTLP.Bindings.Collector.Trace.V1.TraceService_Fields.errorMessage' @:: Lens' ExportTracePartialSuccess Data.Text.Text@ -}
...
{- | Fields :
         ...
         * 'OTel.SDK.OTLP.Bindings.Collector.Trace.V1.TraceService_Fields.resourceSpans' @:: Lens' ExportTraceServiceRequest [OTel.SDK.OTLP.Bindings.Trace.V1.Trace.ResourceSpans]@
         * 'OTel.SDK.OTLP.Bindings.Collector.Trace.V1.TraceService_Fields.vec'resourceSpans' @:: Lens' ExportTraceServiceRequest (Data.Vector.Vector OTel.SDK.OTLP.Bindings.Trace.V1.Trace.ResourceSpans)@ -}
data ExportTraceServiceRequest
  = ExportTraceServiceRequest'_constructor {_ExportTraceServiceRequest'resourceSpans :: !(Data.Vector.Vector OTel.SDK.OTLP.Bindings.Trace.V1.Trace.ResourceSpans),
...
instance Prelude.Show ExportTraceServiceRequest where
  showsPrec _ __x __s
    = Prelude.showChar
        ...
        (Prelude.showString
           (Data.ProtoLens.showMessageShort __x) (Prelude.showChar '}' __s))
instance Data.ProtoLens.Field.HasField ExportTraceServiceRequest "resourceSpans" [OTel.SDK.OTLP.Bindings.Trace.V1.Trace.ResourceSpans] where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
...
instance Data.ProtoLens.Field.HasField ExportTraceServiceRequest "vec'resourceSpans" (Data.Vector.Vector OTel.SDK.OTLP.Bindings.Trace.V1.Trace.ResourceSpans) where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _ExportTraceServiceRequest'resourceSpans
        ...
        resourceSpans__field_descriptor
          = Data.ProtoLens.FieldDescriptor
              ...
              (Data.ProtoLens.MessageField Data.ProtoLens.MessageType ::
                 Data.ProtoLens.FieldTypeDescriptor OTel.SDK.OTLP.Bindings.Trace.V1.Trace.ResourceSpans)
  ...
  parseMessage
    = let
        loop ::
          ...
          -> Data.ProtoLens.Encoding.Growing.Growing Data.Vector.Vector Data.ProtoLens.Encoding.Growing.RealWorld OTel.SDK.OTLP.Bindings.Trace.V1.Trace.ResourceSpans
...
{- | Fields :
         ...
         * 'OTel.SDK.OTLP.Bindings.Collector.Trace.V1.TraceService_Fields.partialSuccess' @:: Lens' ExportTraceServiceResponse ExportTracePartialSuccess@
         * 'OTel.SDK.OTLP.Bindings.Collector.Trace.V1.TraceService_Fields.maybe'partialSuccess' @:: Lens' ExportTraceServiceResponse (Prelude.Maybe ExportTracePartialSuccess)@ -}
