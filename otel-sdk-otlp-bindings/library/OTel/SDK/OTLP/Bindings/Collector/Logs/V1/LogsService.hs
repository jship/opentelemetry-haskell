...
{- | Fields :
         ...
         * 'OTel.SDK.OTLP.Bindings.Collector.Logs.V1.LogsService_Fields.rejectedLogRecords' @:: Lens' ExportLogsPartialSuccess Data.Int.Int64@
         * 'OTel.SDK.OTLP.Bindings.Collector.Logs.V1.LogsService_Fields.errorMessage' @:: Lens' ExportLogsPartialSuccess Data.Text.Text@ -}
...
{- | Fields :
         ...
         * 'OTel.SDK.OTLP.Bindings.Collector.Logs.V1.LogsService_Fields.resourceLogs' @:: Lens' ExportLogsServiceRequest [OTel.SDK.OTLP.Bindings.Logs.V1.Logs.ResourceLogs]@
         * 'OTel.SDK.OTLP.Bindings.Collector.Logs.V1.LogsService_Fields.vec'resourceLogs' @:: Lens' ExportLogsServiceRequest (Data.Vector.Vector OTel.SDK.OTLP.Bindings.Logs.V1.Logs.ResourceLogs)@ -}
data ExportLogsServiceRequest
  = ExportLogsServiceRequest'_constructor {_ExportLogsServiceRequest'resourceLogs :: !(Data.Vector.Vector OTel.SDK.OTLP.Bindings.Logs.V1.Logs.ResourceLogs),
...
{- | Fields :
         ...
         * 'OTel.SDK.OTLP.Bindings.Collector.Logs.V1.LogsService_Fields.partialSuccess' @:: Lens' ExportLogsServiceResponse ExportLogsPartialSuccess@
         * 'OTel.SDK.OTLP.Bindings.Collector.Logs.V1.LogsService_Fields.maybe'partialSuccess' @:: Lens' ExportLogsServiceResponse (Prelude.Maybe ExportLogsPartialSuccess)@ -}
