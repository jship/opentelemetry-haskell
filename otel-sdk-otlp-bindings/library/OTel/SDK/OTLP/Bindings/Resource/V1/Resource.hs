...
{- | Fields :
         ...
         * 'OTel.SDK.OTLP.Bindings.Resource.V1.Resource_Fields.attributes' @:: Lens' Resource [OTel.SDK.OTLP.Bindings.Common.V1.Common.KeyValue]@
         * 'OTel.SDK.OTLP.Bindings.Resource.V1.Resource_Fields.vec'attributes' @:: Lens' Resource (Data.Vector.Vector OTel.SDK.OTLP.Bindings.Common.V1.Common.KeyValue)@
         * 'OTel.SDK.OTLP.Bindings.Resource.V1.Resource_Fields.droppedAttributesCount' @:: Lens' Resource Data.Word.Word32@ -}
data Resource
  = Resource'_constructor {_Resource'attributes :: !(Data.Vector.Vector OTel.SDK.OTLP.Bindings.Common.V1.Common.KeyValue),
